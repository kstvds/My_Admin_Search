...
public class Search_Two_Child {
	...
	Logger logger = Logger.getLogger("Search_Two_Child");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void SearchTwoChild(String browsername) throws Exception {
		test = rep.startTest("Search_Two_Child");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Search_Two_Child/Log-In.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Log-In.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Log-In.jpg";
		...
		/* ####### Searching for specific credit card customer ######### **/
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Search_Two_Child/Customer-Search.jpg");
			...
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Customer-Search.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Customer-Search.jpg";
		...
		/* ####### Selecting the specified credit card customer ######### **/
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Search_Two_Child/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Customer-list.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Customer-list.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Search_Two_Child/Search-Hotel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Search_Two_Child/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Search_Two_Child/Search-Result.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Search_Two_Child/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
