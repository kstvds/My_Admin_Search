...
/* #######  Test for accommodation Search for Credit Card user #########
...
public class Search_Credit_Card {
	...
	public void SearchCreditCard(String browsername) throws Exception {
		...
		try {
			...
			errorpath = Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Log-In.jpg";
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Customer-Search.jpg");
			...
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Customer-Search.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Customer-Search.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Customer-list.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Customer-list.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Search-Hotel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Card/Booking-Channel-filters.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Credit_Card/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
