...
public class Search_Credit_Within_Deadline {
	...
	public void SearchCreditWithinDeadline(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Customer-Search.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg");
			...
			Assert.assertTrue(false, e.getMessage());
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Search/Error/Accommodation_Search_Credit_Within_Deadline/Customer-list.jpg";
		...
		try {
			test.log(LogStatus.INFO, "Starting HotelSearch Within Deadline for Credit");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Within_Deadline/Search-Hotel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Within_Deadline/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Search/Accommodation_Search_Credit_Within_Deadline/Search-Result_Deadline.jpg");
			...
			test.log(LogStatus.INFO, "Ending HotelSearch Within Deadline for Credit");
