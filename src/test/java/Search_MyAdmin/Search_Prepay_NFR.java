...
######   Scenario Logs In, Searches for a specified hotel within NFR rate    ##### */

public class Search_Prepay_NFR {
	...
	public void SearchPrepayNFR(String browsername) throws Exception {
		test = rep.startTest("PrePay Search NFR");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Log-In.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Customer-Search.jpg");
			...
			rep.flush();
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Prepay_NFR/Customer-Search.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Customer-list.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Prepay_NFR/Customer-list.jpg");
		...
		/* ####### Searching Hotel for specified date NFR ######### **/

		try {
			test.log(LogStatus.INFO, "Starting HotelSearch NFR for Prepay");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Search-Hotel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Booking-Channel-filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Search-Result.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Accommodation_Search_Prepay_NFR/Search-Result_Deadline.jpg");
			// String actualdeadline=
			// driverqa.findElement(NewAccoBooking.thirdPartyDeadline).getText();
			// String actualNFR=
			// driverqa.findElement(NewAccoBooking.thirdPartyNFR).getText();
			...
			test.log(LogStatus.INFO, "Ending HotelSearch NFR for Prepay");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Search/Error/Accommodation_Search_Prepay_NFR/Search-Result.jpg");
